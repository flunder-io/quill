...
;if("ul"===i||"ol"===i){const r=[];return t.children.forEachAt(e,n,(t,e,n)=>{const s=t.formats()
;r.push({child:t,offset:e,length:n,indent:s.indent||0,tag:i})}),function convertListHTML(t,e,n){
if(0===t.length){const t=n.pop()
;return e<=0?`</li></${t}>`:`</li></${t}>${convertListHTML([],e-1,n)}`}
const[{child:r,offset:i,length:s,indent:o,tag:l},...a]=t;if(o>e)return n.push(l),
o===e+1?`<${l}><li>${convertHTML(r,i,s)}${convertListHTML(a,o,n)}`:`<${l}><li>${convertListHTML(t,e+1,n)}`
;const u=n[n.length-1]
;return o===e&&l===u?`</li><li>${convertHTML(r,i,s)}${convertListHTML(a,o,n)}`:`</li></${n.pop()}>${convertListHTML(t,e-1,n)}`
...
Module.DEFAULTS={};var O=Module;let w=A("quill:selection");class Range{constructor(t,e=0){
...
;return w.info("getNativeRange",n),n}getRange(){let t=this.getNativeRange()
...
if(w.info("setNativeRange",t,e,n,r),null!=t&&(null==this.root.parentNode||null==t.parentNode||null==n.parentNode))return
...
if("string"==typeof e&&(n=e,e=!1),w.info("setRange",t),null!=t){let n=this.rangeToNative(t)
...
Theme.DEFAULTS={modules:{}},Theme.themes={default:Theme};var C=Theme;let B=A("quill")
...
null==e.theme)throw new Error(`Invalid theme ${e.theme}. Did you register it?`)}else e.theme=C
...
},quill_Quill.events=L.events,quill_Quill.sources=L.sources,quill_Quill.version="1.3.7-cling.3",
quill_Quill.imports={delta:o.a,parchment:i.a,"core/module":O,"core/theme":C}
...
}],["em",matchAlias.bind(matchAlias,"marked")],["b",matchAlias.bind(matchAlias,"bold")],["i",matchAlias.bind(matchAlias,"italic")],["style",function matchIgnore(){
...
let[n,r]=this.prepareMatching(),i=function traverse(t,e,n){
