...
var block_1 = __webpack_require__(51);
var embed_1 = __webpack_require__(52);
  ...
  bindings: {
    ...
    'list autofill': {
      ...
      handler: function handler(range, context) {
        ...
        this.quill.insertText(range.index, ' ', _quill2.default.sources.SILENT);
...
var _syntax = __webpack_require__(62);
...
var _icons = __webpack_require__(36);
...
var _bubble = __webpack_require__(63);
...
_core2.default.register({
  ...
  'formats/marked': _marked2.default,
...
var Marked = function (_Inline) {
  _inherits(Marked, _Inline);

  function Marked() {
    _classCallCheck(this, Marked);

    return _possibleConstructorReturn(this, (Marked.__proto__ || Object.getPrototypeOf(Marked)).apply(this, arguments));
  }

  return Marked;
}(_inline2.default);

Marked.blotName = 'marked';
Marked.tagName = 'EM';
...
var _snow = __webpack_require__(92);
...
var _quill = __webpack_require__(57);
